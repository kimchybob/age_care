  ...
  const list = (anchor) => (
    ...
    >
      <List>
        ...
        <ListItem button key={'Dashboard'} onClick={props.functions("chart")}><ListItemText primary={'Dashboard'} /></ListItem>
        <ListItem button key={'Activity List'} onClick={props.functions("dataGrid")}><ListItemText primary={'Activity List'} /></ListItem>
