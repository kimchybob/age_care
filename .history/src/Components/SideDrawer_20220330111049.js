  ...
  const list = (anchor) => (
    ...
    >
      <List>
        ...
        <ListItem button onClick={()=>{history.push("/carerRegister");}} key={'Carer Registration'}>
          <ListItemIcon><HowToRegIcon/></ListItemIcon>
          <ListItemText primary={'Carer Registration'} />
        </ListItem>
        <ListItem button onClick={()=>{history.push("/residentRegister");}} key={'Resident Registration'}>
          <ListItemIcon><HowToRegIcon/></ListItemIcon>
