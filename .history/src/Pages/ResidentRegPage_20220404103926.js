...
function ResidentRegPage(){
    ...
    //registered resident info
    const [rows,setRows] = useState([]);

    const requestRows = () => {
        var url = 'https://sa3ykxqpng.execute-api.us-east-2.amazonaws.com/getResidentRegistration';
        axios.get(url)
        .then(
            response => {
